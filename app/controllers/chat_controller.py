...
async def websocket_endpoint(user_id: str, websocket: WebSocket, chat_service: ChatService = Depends(ChatService)):
    ...
    try:
        while True:
            ...
            if message.message_type == 'text':
                ...
                await connection_manager.broadcast(f'{user_id}: {filtered_message}')
                ...
                await connection_manager.broadcast(file_link)
